    ...
    public static partial class UnityTcpBridge
    {
        ...
        public static void Start()
        {
            ...
            try
            {
                ...
                // (manage_job) on the pump's worker thread; everything else is drained from
                // the pump's main-thread queue in ProcessCommands.
        ...
        private static void ProcessSingleCommand(ulong requestId, string commandText)
        {
            ...
            try
            {
                ...
                CodelyLogger.Verbose($"[UnityTcpBridge] processing command: {command.type} with requestId: {requestId}");
        ...
        private static void OnBeforeAssemblyReload()
        {
            ...
            // The pump's threads and delegates die with this domain; stop it cleanly and answer
            // anything it had queued. The next domain's Start() launches a fresh pump.
            BackgroundCommandPump.Stop("C# is performing domain reloading.");
